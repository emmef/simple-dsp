...
using Interface = simpledsp::Interface;
using Rate = simpledsp::SampleRate;
...
const simpledsp::SampleRate sampleRate(44100.0f);
} // namespace
...
BOOST_AUTO_TEST_CASE(withZeroInputsThrows) {
  Interface interface =
      Interface::of(inputs, outputs, sampleRate, true, bufferSize);
  BOOST_CHECK_THROW(interface.withInputs(0), std::invalid_argument);
}
...
BOOST_AUTO_TEST_CASE(withZeroOutputThrows) {
  Interface interface =
      Interface::of(inputs, outputs, sampleRate, true, bufferSize);
  BOOST_CHECK_THROW(interface.withOutputs(0), std::invalid_argument);
}
...
BOOST_AUTO_TEST_CASE(withZeroBufferSizeThrows) {
  Interface interface =
      Interface::of(inputs, outputs, sampleRate, true, bufferSize);
  BOOST_CHECK_THROW(interface.withBufferSize(0), std::invalid_argument);
}

BOOST_AUTO_TEST_CASE(tooLargeInputsThrows) {
  BOOST_CHECK_THROW(
      Interface::of(largeInputs, outputs, sampleRate, true, bufferSize),
      std::invalid_argument);
}
...
BOOST_AUTO_TEST_CASE(withTooLargeInputsThrows) {
  Interface interface =
      Interface::of(inputs, outputs, sampleRate, true, bufferSize);
  BOOST_CHECK_THROW(interface.withInputs(largeInputs), std::invalid_argument);
}

BOOST_AUTO_TEST_CASE(tooLargeOutputsThrows) {
  BOOST_CHECK_THROW(
      Interface::of(inputs, largeOutputs, sampleRate, true, bufferSize),
      std::invalid_argument);
}
...
BOOST_AUTO_TEST_CASE(withTooLargeOutputsThrows) {
  Interface interface =
      Interface::of(inputs, outputs, sampleRate, true, bufferSize);
  BOOST_CHECK_THROW(interface.withOutputs(largeOutputs), std::invalid_argument);
}

BOOST_AUTO_TEST_CASE(tooLargeBufferSizeThrows) {
  BOOST_CHECK_THROW(
      Interface::of(inputs, outputs, sampleRate, true, largeBufferSize),
      std::invalid_argument);
}
...
BOOST_AUTO_TEST_CASE(differentInputsNotEqual) {
  Interface interface1 =
      Interface::of(inputs, outputs, sampleRate, true, bufferSize);
  Interface interface2 =
      Interface::of(inputs + 1, outputs, sampleRate, true, bufferSize);
  BOOST_CHECK(interface1 != interface2);
}
...
BOOST_AUTO_TEST_CASE(differentOutputsNotEqual) {
  Interface interface1 =
      Interface::of(inputs, outputs, sampleRate, true, bufferSize);
  Interface interface2 =
      Interface::of(inputs, outputs + 1, sampleRate, true, bufferSize);
  BOOST_CHECK(interface1 != interface2);
}
...
BOOST_AUTO_TEST_CASE(differentSampleRateNotEqual) {
  Interface interface1 =
      Interface::of(inputs, outputs, sampleRate, true, bufferSize);
  Interface interface2 = Interface::of(
      inputs, outputs, Rate(sampleRate.rate() + 1), true, bufferSize);
  BOOST_CHECK(interface1 != interface2);
}
...
BOOST_AUTO_TEST_CASE(differentRealTimeNotEqual) {
  Interface interface1 =
      Interface::of(inputs, outputs, sampleRate, true, bufferSize);
  Interface interface2 =
      Interface::of(inputs, outputs, sampleRate, false, bufferSize);
  BOOST_CHECK(interface1 != interface2);
}
...
BOOST_AUTO_TEST_CASE(differentBufferSizeNotEqual) {
  Interface interface1 =
      Interface::of(inputs, outputs, sampleRate, true, bufferSize);
  Interface interface2 =
      Interface::of(inputs, outputs, sampleRate, false, bufferSize + 1);
  BOOST_CHECK(interface1 != interface2);
}
}
