...
namespace {
  ...
  template <class Q>
  void writeUntilFullThenRead(size_t queueSize) {
    Q queue(queueSize);
    Generator generator;
  ...
  template <class Q>
  void putAndGetSyncedMoreThanFullSize(size_t queueSize) {
    Q queue(queueSize);
    Generator generator;
  ...
  template <class Q>
  void writeMoreThanBufferSizeInitial(size_t queueSize) {
    Q queue(queueSize);
    Generator generator;
    fillMoreThanBufferSize(queue, generator);
  }
...
BOOST_AUTO_TEST_SUITE(QueueTests)
  ...
  BOOST_AUTO_TEST_CASE(putAndGetSyncedMoreThanFullSizeNormalSize) {
    ...
    putAndGetSyncedMoreThanFullSize<simpledsp::QueueProducerConsumer<int> >(QUEUESIZE);
  }
  ...
  BOOST_AUTO_TEST_CASE(writeSomeEmptyThenwriteUntilFullThenReadNormalSize) {
    ...
    writeSomeEmptyThenwriteUntilFullThenRead<simpledsp::QueueUnsafe<int> >(QUEUESIZE);
    writeSomeEmptyThenwriteUntilFullThenRead<simpledsp::QueueProducerConsumer<int> >(QUEUESIZE);
  }
  ...
  BOOST_AUTO_TEST_CASE(writeSomeEmptyThenwriteUntilFullThenReadSizeOne) {
    ...
    writeSomeEmptyThenwriteUntilFullThenRead<simpledsp::QueueProducerConsumer<int> >(1);
  }
  ...
  BOOST_AUTO_TEST_CASE(writeMoreThanBufferSizeInitialNormalSize) {
    ...
    writeMoreThanBufferSizeInitial<simpledsp::QueueProducerConsumer<int> >(QUEUESIZE);
  }
  ...
  BOOST_AUTO_TEST_CASE(writeMoreThanBufferSizeAlreadyUsedSomewhatNormalSize) {
    ...
    writeMoreThanBufferSizeAlreadyUsedSomewhat<simpledsp::QueueUnsafe<int> >(QUEUESIZE);
    writeMoreThanBufferSizeAlreadyUsedSomewhat<simpledsp::QueueProducerConsumer<int> >(QUEUESIZE);
  }
  ...
  BOOST_AUTO_TEST_CASE(writeMoreThanBufferSizeAlreadyUsedSomewhatSizeOne) {
    ...
    writeMoreThanBufferSizeAlreadyUsedSomewhat<simpledsp::QueueProducerConsumer<int> >(1);
  }

  BOOST_AUTO_TEST_CASE(writeMoreThanBufferSizeAlreadyUsedMoreThanBufferSizeNormalSize) {
    writeMoreThanBufferSizeAlreadyUsedMoreThanBufferSize<simpledsp::Queue<int> >(QUEUESIZE);
    writeMoreThanBufferSizeAlreadyUsedMoreThanBufferSize<simpledsp::QueueUnsafe<int> >(QUEUESIZE);
    writeMoreThanBufferSizeAlreadyUsedMoreThanBufferSize<simpledsp::QueueProducerConsumer<int> >(QUEUESIZE);
  }

  BOOST_AUTO_TEST_CASE(writeMoreThanBufferSizeAlreadyUsedMoreThanBufferSizeSizeOne) {
    writeMoreThanBufferSizeAlreadyUsedMoreThanBufferSize<simpledsp::Queue<int> >(1);
    writeMoreThanBufferSizeAlreadyUsedMoreThanBufferSize<simpledsp::QueueUnsafe<int> >(1);
    writeMoreThanBufferSizeAlreadyUsedMoreThanBufferSize<simpledsp::QueueProducerConsumer<int> >(1);
  }
