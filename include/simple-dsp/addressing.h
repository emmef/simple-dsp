...
static constexpr size_t SDSP_MEMORY_MODEL_STOLEN_ADDRESS_BITS =
    ::std::clamp(size_t(SDSP_OVERRIDE_MEMORY_MODEL_STOLEN_ADDRESS_BITS),
                 size_t(1), sizeof(size_t) * 8);
#else
/*
...
template <typename size_type> struct SizeTypeMax {
...
template <typename T, typename size_type> struct SizeTypeMaxForType {
  static constexpr size_type size_type_max = SizeTypeMax<size_type>::value;
  static_assert(alignof(T) < size_type_max,
                "Size type too small for value type");
...
struct AddressRange {
  static constexpr size_type absolueMaximumSize =
      SizeTypeMaxForType<T, size_type>::value;
  static constexpr size_type sizeTypeLimit = SizeTypeMax<size_type>::limit;

  static constexpr size_type maximumArraySize =
      is_within_excl<size_type>(customMaximum, 0, absolueMaximumSize)
          ? customMaximum
          : absolueMaximumSize;
   ...
   */
  static constexpr bool isValidProductRelaxed(size_type value1,
                                              size_type value2) {
   ...
   * @return {@code true} if the product does not exceed the maximum.
   */
  static constexpr bool isValidProductStrict(size_type value1,
                                             size_type value2) {
  ...
  static size_type validStrictGet(size_type value) {
    ...
    throw std::invalid_argument(
        "Size::get_valid_product: value exceeds exceeds maximum addressing "
        "range for type or is zero.");
  }
  ...
  static size_type validRelaxedGet(size_type value) {
    ...
    throw std::invalid_argument("Size::get_valid_product: value exceeds "
                                "exceeds maximum addressing range.");
  }
   ...
   * @param value1 The first value
   * @param value2 The second value
   * @param validGet Indicates whether the first value or result is returned if
   * result is valid.
   * @return the first value or result, based on the value of validGet.
   */
  static size_type validProductStrictGet(size_type value1, size_type value2,
                                         ValidGet validGet) {
    ...
    throw std::invalid_argument("Size::get_valid_product: product of values "
                                "exceeds maximum addressing range for type or"
   ...
   * @return the first value or result, based on the value of validGet.
   */
  static size_type validProductRelaxedGet(size_type value1, size_type value2,
                                          ValidGet validGet) {
    ...
    throw std::invalid_argument("Size::get_valid_product: product of values "
                                "exceeds exceeds maximum addressing range for"
                                " type.");
  }
   ...
   * @return the first value or result, based on the value of validGet.
   */
  static size_type validSumStrictGet(size_type value1, size_type value2,
                                     ValidGet validGet) {
    ...
    throw std::invalid_argument(
        "Size::get_valid_product: sum of values exceeds exceeds maximum "
        "addressing range for type"
   ...
   * @return the first value or result, based on the value of validGet.
   */
  static size_type validSumRelaxedGet(size_type value1, size_type value2,
                                      ValidGet validGet) {
...
struct BaseSize {
  ...
  /**
   * @return Returns {@code true} if both values and their product are nonzero
   ...
   */
  static size_type validProductGet(size_type value1, size_type value2,
                                   ValidGet validGet) {
   ...
   * invalid_argument otherwise.
   */
  static size_type validSumGet(size_type value1, size_type value2,
                               ValidGet validGet) {
...
struct BaseOffset {
   ...
   * and smaller than maximum, {@code false} otherwise.
   */
  static constexpr size_type isValidProduct(size_type value1,
                                            size_type value2) {
   ...
   * invalid_argument otherwise.
   */
  static constexpr size_type validProductGet(size_type value1, size_type value2,
                                             ValidGet validGet) {
   ...
   * invalid_argument otherwise.
   */
  static constexpr size_type validSumGet(size_type value1, size_type value2,
                                         ValidGet validGet) {
...
template <typename S> struct IndexBase {
  ...
  sdsp_nodiscard static S arrayIndex(S i, S size) {
    return Array::index(i, size);
  }

  sdsp_nodiscard static S arrayOffset(S i, S maxOffset) {
    return Array::offset(i, maxOffset);
  }

  sdsp_nodiscard static S index(S i, S size) { return Method::index(i, size); }

  sdsp_nodiscard static S offset(S i, S maxOffset) {
    return Method::offset(i, maxOffset);
  }
};
